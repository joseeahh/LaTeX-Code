...
\begin{ex}[Subgroup Product]
    \begin{itemize}
        ...
        \item We show an example of using the order formula in \autoref{prop3.13} to prove that a finite group is a product of two of its subgroups. Let $G = S_4$, $H = D_8$, and $K = \gen{(1\ 2\ 3)}$, where $D_8$ is considered as a subgroup of $S_4$ by associating each symmetry with a permutation on 4 verticies. Explictly, these are the elements of $S_4$:
        \[1, (1\ 2\ 3\ 4), (1\ 3)(2\ 4), (1\ 4\ 3\ 2), (2\ 4), (1\ 2)(3\ 4), (1\ 3), (1\ 4)(2\ 3)\]
        In Exercise 3.2.8, we show that we may use Lagrange's Theorem to show $H \cap K = 1$, hence $|HK| = 24$ by \autoref{prop3.13}. 
    \end{itemize}
\end{ex}