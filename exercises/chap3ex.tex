...
\begin{problems}
    ...
    \end{sol}
    \item Prove the lattice of subgroups of $A_4$ given in the text is correct. (By the preceding exercise and the comments following Lagrange's Theorem, $A_4$ has no subgroup of order $6$.)
